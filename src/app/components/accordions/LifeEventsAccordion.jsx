  ...
  render() {
    ...
    return (
      <div>
        <Segment inverted>
          <Accordion inverted>
            <Accordion.Title active={activeIndex === 0} onClick={this.handleClick}>
              <Icon name='dropdown' />
              What is a dog?
            </Accordion.Title>
            ...
            <Accordion.Title active={activeIndex === 1} onClick={this.handleClick}>
              <Icon name='dropdown' />
            ...
            <Accordion.Title active={activeIndex === 2} onClick={this.handleClick}>
              <Icon name='dropdown' />
